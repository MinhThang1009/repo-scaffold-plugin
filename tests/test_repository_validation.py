    ...
    def test_critical_policy_claims_must_track_every_affected_path(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            cases = {
                ...
                "github-action-pin-git-refs-api": "skills/repo-scaffold/scripts/sync_action_pins.py",
                "github-action-pin-git-tags-api": "skills/repo-scaffold/scripts/sync_action_pins.py",
