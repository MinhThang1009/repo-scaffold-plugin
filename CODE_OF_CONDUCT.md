...
possible violation, contact the repository maintainer privately through the
same private channel used to share this local plugin. If no private maintainer
channel is available, request one without disclosing incident details publicly.
For conduct hosted on GitHub, GitHub's private abuse-reporting process is also
available through [GitHub Support].
...
involved and the community as a whole. Depending on the severity of a violation,
...
[https://www.contributor-covenant.org/version/3/0/][covenant].

Contributor Covenant is stewarded by the Organization for Ethical Source and
licensed under [CC BY-SA 4.0].

For answers to common questions about Contributor Covenant, see the [FAQ].
[Translations] and additional [enforcement and community guideline resources]
are also available. The enforcement ladder was inspired by the work of
[Mozilla's code of conduct team].

[CC BY-SA 4.0]: https://creativecommons.org/licenses/by-sa/4.0/
[covenant]: https://www.contributor-covenant.org/version/3/0/
[enforcement and community guideline resources]: https://www.contributor-covenant.org/resources
