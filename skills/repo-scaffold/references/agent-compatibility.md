...
The official Anthropic marketplace is `claude-plugins-official`; use its in-app
submission form for a public listing. This repository's
`repo-scaffold-plugins` marketplace remains a separate local or private
distribution source.
