...
assets. Its packaged README retains every first-party relative documentation
target that it references. The archive also contains `.codex-plugin/plugin.json` for direct Codex
